    ...
    <flux:main>
        ...
        @if ($this->purchases->isEmpty() && !$search)
            <div class="rounded-2xl border border-zinc-800 bg-zinc-900 py-20 text-center">
                <p class="text-zinc-500">You haven't purchased anything yet.</p>
                <a href="{{ route('products.index') }}" wire:navigate class="mt-4 inline-block rounded-xl bg-white px-5 py-2 text-sm font-semibold text-zinc-900 hover:bg-zinc-100">
                    Browse products
                </a>
            </div>
        @else
